...
echo "======================================"
echo "Vibe Anywhere Agent Binary Builder"
echo "======================================"
echo ""
...
BINARY_NAME="vibe-anywhere-agent"
...
if [ ! -f "$DIST_DIR/agent-bundled.js" ]; then
  echo "Error: Bundle creation failed"
  exit 1
fi

BUNDLE_SIZE=$(du -h "$DIST_DIR/agent-bundled.js" | cut -f1)
