 ...
 * The Vibe Anywhere agent is a standalone binary (no Node.js dependency)
 * Other tech stacks (Node.js, Python, etc.) are installed separately based on configuration
 */
...
echo "[7/8] Setting up Vibe Anywhere agent..."
mkdir -p /opt/vibe-anywhere-agent
chown -R kobozo:kobozo /opt/vibe-anywhere-agent

# Create systemd service for agent (using standalone binary)
